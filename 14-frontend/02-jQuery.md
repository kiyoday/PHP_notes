...
AJAX = 异步 JavaScript 和 XML（Asynchronous JavaScript and XML）。它并不是一种单一的技术，而是有机地利用了一系列交互式网页应用相关的技术所形成的结合体。简短地说，在不重载整个网页的情况下，AJAX 通过后台加载数据，并在网页上进行显示，其最大的特点就是`异步`。

### AJAX 的优势与劣势

| 优势                   | 劣势                                                         |
| ---------------------- | ------------------------------------------------------------ |
| 不需要插件支持         | 浏览器对 XMLHttpRequest 对象支持度不足(关于 XMLHttpRequest 对象稍后我们会介绍到) |
| 优秀的用户体验         | 破坏浏览器前进、“后退”按钮的正常功能                         |
| 提高 Web 程序的性能    | 对搜索引擎的支持的不足                                       |
| 减轻服务器和带宽的负担 | 开发和调试工具的缺乏                                         |
...
![图片描述](../.img/uid920932-20190517-1558077178745)
...
![图片描述](../.img/uid920932-20190517-1558077287375)
...
![图片描述](../.img/uid920932-20190517-1558077331545)
...
![图片描述](../.img/uid920932-20190517-1558077360497)
...
![图片描述](../.img/uid920932-20190517-1558077387525)
...
![图片描述](../.img/uid920932-20190517-1558077410132)
...
![图片描述](../.img/uid920932-20190517-1558077439662)

#### 3.2.2 $.getJSON()

.getJson() 用于加载 JSON 文件，与.*g**e**t**J**s**o**n*()用于加载*J**S**O**N*文件，与.getScript() 的用法相同。语法：
...
![图片描述](../.img/uid920932-20190517-1558077461481)
...
![图片描述](../.img/uid920932-20190517-1558077495738)

![图片描述](../.img/uid920932-20190517-1558077514606)
